...
add_action('wp_enqueue_scripts', 'autologin_ajax_enqueue');

function autologin_ajax_request()
{
    check_ajax_referer('akjhuh767gGgGJ8uUfdl78sfdsd', 'security');
...
add_action('wp_ajax_autologin_ajax_request', 'autologin_ajax_request');
// For non-logged in users (in a theme for example):
add_action('wp_ajax_nopriv_autologin_ajax_request', 'autologin_ajax_request');
